...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE_LAYER] = LAYOUT_60_ansi( /* BASE LAYER */
        ...
        KC_LCTL,               KC_LGUI, LM(_FUNCTION_LAYER, MOD_LALT), KC_SPC, MO(_ARROW_LAYER), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    ...
    [_MOUSE_LAYER] = LAYOUT_60_ansi( /* MOUSE CONTROL LAYER */
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, KC_WH_U, KC_MS_U, KC_WH_D, KC_BTN1, _______, KC_BTN1, KC_WH_U, KC_MS_U, KC_WH_D, _______, _______, _______, _______,
        _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN2, _______, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
        _______, _______, _______, _______, _______, _______, _______, _______
    ),
